...
public class Market {
    public void initMobilePhone(String login) {
        ...
        market.createMobilePhone(login, mobilePhone);
    }

    public void initHeadphones(String login) {
        Market market = new Market();
        Scanner scanner = new Scanner(System.in);
        System.out.println("Enter brand: ");
        String brand = scanner.nextLine();
        ...
        market.createHeadphones(login, headphones);
    }

    public void initSmartwatch(String login) {
        Market market = new Market();
        Scanner scanner = new Scanner(System.in);
        System.out.println("Enter brand: ");
        String brand = scanner.nextLine();
        ...
        market.createSmartWatch(login, smartwatch);
    }

    public void initGameTablet(String login) {
        Market market = new Market();
        Scanner scanner = new Scanner(System.in);
        System.out.println("Enter brand: ");
        String brand = scanner.nextLine();
        ...
        market.createGamingTablet(login, gamingTablet);
    }

    public void initSmartPhone(String login) {
        Market market = new Market();
        Scanner scanner = new Scanner(System.in);
        System.out.println("Enter brand: ");
        String brand = scanner.nextLine();
        ...
        market.createSmartphone(login, smartphone);
    }

    public void initDrawTablet(String login) {
        Scanner scanner = new Scanner(System.in);
        Market market = new Market();
        System.out.println("Enter brand: ");
        String brand = scanner.nextLine();
        ...
        market.createDrawingTablet(login, drawingTablet);
    }

    public void initBusTablet(String login) {
        Scanner scanner = new Scanner(System.in);
        Market market = new Market();
        System.out.println("Enter brand: ");
        String brand = scanner.nextLine();
        ...
        market.createBusTablet(login, businessTablet);
    }
    ...
    public void createGamingTablet(String login, GamingTablet gamingTablet) {
        try {
            Class.forName("org.postgresql.Driver");
            Connection con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/as3help", "postgres", "mercytop38");
    ...
    public void createBusTablet(String login, BusinessTablet businessTablet) {
        try {
            Class.forName("org.postgresql.Driver");
            Connection con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/as3help", "postgres", "mercytop38");
    ...
    public void createDrawingTablet(String login, DrawingTablet drawingTablet) {
        try {
            Class.forName("org.postgresql.Driver");
            Connection con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/as3help", "postgres", "mercytop38");
    ...
    public void createMobilePhone(String login, MobilePhone mobilephone){
        try {
            Class.forName("org.postgresql.Driver");
            Connection con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/as3help", "postgres", "mercytop38");
    ...
    public void createSmartphone(String login, Smartphone smartphone){
        try {
            Class.forName("org.postgresql.Driver");
            Connection con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/as3help", "postgres", "mercytop38");
    ...
    public void createSmartWatch(String login, Smartwatch smartwatch){
        try {
            Class.forName("org.postgresql.Driver");
            Connection con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/as3help", "postgres", "mercytop38");
    ...
    public void createHeadphones(String login, Headphones headphones){
        try {
            Class.forName("org.postgresql.Driver");
            Connection con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/as3help", "postgres", "mercytop38");
